...
public class TicTacToeGame {
    ...
    public void gameInitialization() {
        fillInitMatrix(getInitMatrixFromUser());
        printInitMatrix();
    }

    private String getInitMatrixFromUser () {
        Scanner scanner = new Scanner(System.in);
        System.out.print("Enter cells: ");
        return scanner.next().trim();  // trim to avoid spaces after input
    }
